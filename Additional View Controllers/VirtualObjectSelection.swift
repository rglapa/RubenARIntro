...
protocol VirtualObjectSelectionViewControllerDelegate: class {
    func virtualObjectSelectionViewController(_ selectionViewController:
        VirtualObjectSelectionViewController, didSelectObject: VirtualObject)
    func virtualObjectSelectionViewController(_ selectionViewController:
        VirtualObjectSelectionViewController, didDeselectObject: VirtualObject)
}
...
class VirtualObjectSelectionViewController: UITableViewController {
    ...
    func updateObjectAvailability(for planeAnchor: ARPlaneAnchor?) {
        ...
        let changedRows = newEnabledVirtualObjectRows.symmetricDifference(newEnabledVirtualObjectRows)
