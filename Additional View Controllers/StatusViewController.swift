...
//  RubenARIntro
//
//  Created by Ruben Glapa on 4/16/18.
...
class StatusViewController: UIViewController {
    ...
    func showMessage(_ text: String, autoHide: Bool = true) {
        ...
        // Maker sure status is showing.
        setMessageHidden(false, animated: true)
        
        if autoHide {
            messageHideTimer = Timer.scheduledTimer(withTimeInterval: displayDuration, repeats: false, block:
                { [weak self] _ in
    ...
    func scheduleMessage(_ text: String, inSeconds seconds: TimeInterval, messageType: MessageType) {
        ...
        let timer = Timer.scheduledTimer(withTimeInterval: seconds, repeats: false, block: { [weak self]
            timer in
    ...
    func escalateFeedback(for trackingState: ARCamera.TrackingState, inSeconds seconds: TimeInterval) {
        ...
        let timer = Timer.scheduledTimer(withTimeInterval: seconds, repeats: false, block: { [unowned self] _
            in
