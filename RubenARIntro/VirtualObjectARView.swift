...
//  RubenARIntro
//
//  Created by Ruben Glapa on 4/11/18.
...
class VirtualObjectARView: ARSCNView {
    ...
    func smartHitTest(_ point: CGPoint,
        ...
        if let existingPlaneUsingGeometryResult = results.first(where: { $0.type
            == .existingPlaneUsingGeometry }),
            let planeAchor = existingPlaneUsingGeometryResult.anchor as? ARPlaneAnchor,
                allowedAlignments.contains(planeAchor.alignment) {
